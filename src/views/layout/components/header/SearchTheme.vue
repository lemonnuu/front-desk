<template>
  <div class="">
    <div class="text-xs mb-1 text-zinc-400">每日Bing图</div>
...
<script setup>
import { ref } from 'vue'
import { getBingImgList } from '../../../../api/imgs'
...
const getThemeData = async () => {
  const themes = await getBingImgList()
  themeData.value = {
    big: themes[0],
    list: themes.splice(1, themes.length)
  }
  console.log('themeData.value', themeData.value)
}
getThemeData()
</script>
